...
```
python3 -m concept_checks.kinetics.system_dynamics
```
...
```
cd existing_repo
git remote add origin https://gitlab.com/u-space/gnc/formations/spacecraft-dynamics-and-control.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/u-space/gnc/formations/spacecraft-dynamics-and-control/-/settings/integrations)
